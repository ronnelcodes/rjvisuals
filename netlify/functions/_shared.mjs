...
export function storageSignedUrl(value){if(/^https?:\/\//i.test(value||''))return value;const e=requireEnv();const path=String(value||'');return `${e.url}/storage/v1${path.startsWith('/')?'':'/'}${path}`;}
